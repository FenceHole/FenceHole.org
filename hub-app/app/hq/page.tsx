...
const MODULES = [
  ...
  { id: 'ai-router', name: 'AI Router', desc: 'Routes tasks to the cheapest safe model (Qwen/Claude).', href: '/hq/hermes', live: true },
  { id: 'hermes', name: 'Hermes Agent AI', desc: 'Agent coordinator: drafts plans, routed through the AI Router.', href: '/hq/hermes', live: true },
  ...
  { id: 'fundraising', name: 'Fundraising / Sponsors', desc: 'Sponsor pipeline and fundraising notes.', href: '/hq', live: false },
  { id: 'outreach', name: 'Outreach Drafts', desc: 'Drafts for review — nothing sends without approval.', href: '/hq', live: false },
