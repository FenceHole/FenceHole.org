...
const MODULES = [
  ...
  { id: 'ai-router', name: 'AI Router', desc: 'Routes tasks to the cheapest safe model or agent.', href: '/hq', live: false },
  { id: 'hermes', name: 'Hermes Agent AI', desc: 'Agent coordinator: task packets, queue, approvals.', href: '/hq', live: false },
